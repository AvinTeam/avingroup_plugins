<?php
namespace AvinGroup\App\Core\Traits;
...
trait JDF
{
    ...
    public function date($data, $type = '')
    {
        ...
        $ch_date = (strpos($data, '-')) ? $this->gregorian_to_jalali($y, $m, $d, '/') : $this->jalali_to_gregorian($y, $m, $d, '-');
        ...
        if ($type == 'time') {
            ...
            if (strpos($ch_date, '/')) {
                ...
                $ch_date = $this->jalali_to_gregorian($y, $m, $d, '-');
        ...
        foreach ($array as $type => $num) {
            ...
            switch ($type) {
                ...
                case 'ss':
                    ...
                    $array[ $type ] = (($num > 99) ? str_ireplace([ '12', '13', '14', '19', '20' ]
